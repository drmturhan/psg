...
namespace Identity.DataAccess
{
    ...
    public class KullaniciYonetici : UserManager<Kullanici>, ICinsiyetSecimListesiSaglar
    {
        ...
        {
            KullaniciKisi kisi = Depo.KisiyiAl(user.Kisi.Ad, user.Kisi.Soyad, user.Kisi.DogumTarihi, user.Kisi.CinsiyetNo);
        ...
        public async Task<bool> KullaniciAdiKullanimdaAsync(string userName)
        {
            return await Depo.KullaniciVarAsync(userName);
        }
